...
const VerticalCharacters = memo(() => {
  ...
  // const { interestingLabel, bidiHighlightMouseOver, bidiHighlightMouseLeave } =
  //   useBidiHighlight("groupname");
    ...
    >
      {CharacterList.map((item) => {
        ...
        return (
          ...
          >
            <label style={{ display: "flex", flexDirection: "column", rowGap: '8px', alignItems: 'center', height: 'fit-content' }}>
              <input
                style={{ display: 'none' }}
                type="checkbox"
              ...
              <div className="CharacterPortrait"
                style={{ width: "60px", height: "80px", backgroundColor: color }}
              ></div>
              {item}
            </label>
          </div>
